  ...
  return (
    <div className="space-y-20 pb-16">
      ...
      <section className="relative pt-12 pb-20 overflow-hidden">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[600px] h-[350px] bg-brand-600/20 blur-[120px] rounded-full pointer-events-none"></div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  Only answer what applies to you. Educational asks for CGPA; Sports asks for Athlete Level; Healthcare asks for NEET score.
                </p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  Direct official links to scholarships.gov.in, Digital Gujarat, AICTE, CSIR, and DST official portals.
                </p>
              </div>
            </div>
            ...
            <div className="flex space-x-4">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400 leading-relaxed">
                  No login required, no unnecessary document uploads. Instant accurate scholarship matches in under 10 seconds.
                </p>
              </div>
            </div>
