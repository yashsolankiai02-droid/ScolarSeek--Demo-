        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link to="/search" className="hover:text-brand-700 transition-colors">Search Engine</Link>
              </li>
              <li>
                <Link to="/search?sector=Educational" className="hover:text-brand-700 transition-colors">Education Scholarships</Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <Link to="/search?sector=Healthcare" className="hover:text-brand-700 transition-colors">Healthcare & Nursing</Link>
              </li>
              <li>
                <Link to="/search?sector=Research%20%26%20Innovation" className="hover:text-brand-700 transition-colors">Research & CSIR Grants</Link>
              </li>
              <li>
                <Link to="/search?sector=Arts%20%26%20Culture" className="hover:text-brand-700 transition-colors">Arts & Culture Fellowship</Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-sm">
              ...
              <li>
                <a href="https://digitalgujarat.gov.in" target="_blank" rel="noreferrer" className="flex items-center hover:text-brand-700 transition-colors">
                  <span>Digital Gujarat Portal</span>
                  <ExternalLink className="w-3 h-3 ml-1.5 opacity-60" />
                </a>
              </li>
              <li>
                <a href="https://startupindia.gov.in" target="_blank" rel="noreferrer" className="flex items-center hover:text-brand-700 transition-colors">
